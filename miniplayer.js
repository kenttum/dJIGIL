...
g.h.sF=function(){this.tooltip=new g.jQ(this.player,this);g.J(this,this.tooltip);g.fM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Ac=new g.mN(this.player);g.J(this,this.Ac);this.Hg=new g.W({D:"div",K:"ytp-miniplayer-scrim"});g.J(this,this.Hg);this.Hg.Ca(this.element);this.S(this.Hg.element,"click",this.UA);var a=new g.W({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.hK()]});g.J(this,a);a.Ca(this.Hg.element);
this.S(a.element,"click",this.Pi);a=new g.$1(this.player,this);g.J(this,a);a.Ca(this.Hg.element);this.Vp=new g.W({D:"div",K:"ytp-miniplayer-controls"});g.J(this,this.Vp);this.Vp.Ca(this.Hg.element);this.S(this.Vp.element,"click",this.UA);var b=new g.W({D:"div",K:"ytp-miniplayer-button-container"});g.J(this,b);b.Ca(this.Vp.element);a=new g.W({D:"div",K:"ytp-miniplayer-play-button-container"});g.J(this,a);a.Ca(this.Vp.element);var c=new g.W({D:"div",K:"ytp-miniplayer-button-container"});g.J(this,c);
c.Ca(this.Vp.element);this.oO=new g.LO(this.player,this,!1);g.J(this,this.oO);this.oO.Ca(b.element);b=new g.JO(this.player,this);g.J(this,b);b.Ca(a.element);this.nextButton=new g.LO(this.player,this,!0);g.J(this,this.nextButton);this.nextButton.Ca(c.element);this.Kg=new g.WP(this.player,this);g.J(this,this.Kg);this.Kg.Ca(this.Hg.element);this.Jc=new g.UO(this.player,this);g.J(this,this.Jc);g.fM(this.player,this.Jc.element,4);this.KA=new g.W({D:"div",K:"ytp-miniplayer-buttons"});g.J(this,this.KA);
g.fM(this.player,this.KA.element,4);a=new g.W({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.hK()]});g.J(this,a);a.Ca(this.KA.element);this.S(a.element,"click",this.Pi);a=new g.W({D:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.oK()]});g.J(this,a);a.Ca(this.KA.element);this.S(a.element,"click",this.TW);this.S(this.player,"presentingplayerstatechange",
this.Sc);this.S(this.player,"appresize",this.yb);this.S(this.player,"fullscreentoggled",this.yb);this.yb()};
